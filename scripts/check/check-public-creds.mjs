...
export const KNOWN_LITERAL_CREDS = new Set([
  "open-sse/services/usage.ts:583:minimax", // TODO(6A.8): pre-existing FP — TS fn-param type, not a credential (moved 543→547 by #3838/#4293, then 547→583 by codebuddy-cn import insertion)
  "open-sse/services/usage.ts:583:minimax-cn", // TODO(6A.8): pre-existing FP — TS fn-param type, not a credential (moved 543→547 by #3838/#4293, then 547→583 by codebuddy-cn import insertion)
]);
